...
if (isset($_POST["addDaftarPerika"])) {
    if (addDetailPeriksa($_POST) > 0) {
        ...
        document.location.href= 'add_detail_periksa_form.php?id=$id';
        </script> ";
    } else {
...
<head>
    ...
    <title>Tambah Detail Obat Periksa</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
  </head>
  <body>
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Tambah Detail Obat Periksa</a>
        ...
        <div class="mb-3">
            ...
            <div class="card">
                    <span>
                        ...
                        <button href="" class="btn btn-danger badge"> <a href="hapus_detail_periksa.php?id=<?= $do['id']?>&id_periksa=<?= $do['id_periksa']?>" class="text-white" style="text-decoration:none"> x | </a><?= $do['nama_obat']?></button>
                        <?php endforeach;?>
                    </span>
                </div>
        </div>

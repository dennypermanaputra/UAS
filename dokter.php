...
<head>
  ...
  <nav class="navbar navbar-dark bg-primary">
    ...
    <div class="container p-5 m-5">
        ...
        <a href="add_dokter_form.php" class="btn btn-primary mt-5"> + Tambah</a>
        ...
        foreach ($dokterData as $m) : ?>
            <tr>
                ...
                <td><?= $m['no_hp']?></td>
                <td>
                    <a class="badge bg-danger text-white" href="hapus_dokter.php?id=<?= $m['id'] ?>">Hapus </a>
                    <a class="badge bg-info text-white" href="edit_dokter_form.php?id=<?= $m['id'] ?>"> Edit</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>

...
<head>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Tambah Obat</a>
    ...
    <div class="container p-5 m-5">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" name="nama_obat">
        </div>
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Kemasan</label>
            <input type="text" class="form-control" id="exampleInputPassword1" name="kemasan">
        </div>
        <div class="mb-3">

...
<head>
  ...
  <nav class="navbar navbar-dark bg-primary">
    ...
    <div class="container p-5 m-5">
        ...
        <a href="add_obat_form.php" class="btn btn-primary mt-5">+ Tambah</a>
        
        <table class="table table-striped">
        <thead>
            <tr>
            <th scope="col">#</th>
            <th scope="col">NamaObat</th>
        ...
        foreach ($obatData as $m) : ?>
            <tr>
                ...
                <td><?= $m['harga']?></td>
                <td>
                    <a class="badge bg-danger text-white" href="hapus_obat.php?id=<?= $m['id'] ?>">Hapus </a>
                    <a class="badge bg-info text-white" href="edit_obat_form.php?id=<?= $m['id'] ?>"> Edit</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>

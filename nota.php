  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <?php foreach($data as $p):?>
        ...
        <div class="card mx-auto" style="width: 50rem;">
            <div class="card-body">
                <h5 class="card-title mb-5 text-start"><b>Nota Pembayaran</b></h5>
                ...
                <div class="row">
                    ...
                    <div class="col-4 text-end">
                        ...
                        <b class="text-danger">Total Rp <?=number_format( ($totalObat+150000), 0, ',', '.')?>,00</b></p>
                    </div>
                </div>
